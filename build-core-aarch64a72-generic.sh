...
make -C "phoenix-rtos-usb" usb usb-install USB_HCD_LIBS="libusbxhci libvcmbox" USB_HOSTDRV_LIBS="libusbdrv-usbkbd libusbdrv-usbmouse libusbdrv-umass" USB_HOSTDRV_DEP_LIBS="libext2"
